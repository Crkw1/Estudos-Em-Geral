import DatagramChannelImpl.AbstractSelectableChannels;
...
public class StreamAPI {
    ...
    public static void main(String[] args) {
       ...
       // numerosAleatorios.forEach(System.out::println); // ex de lambda
      ...
      /*  Set<String> numerosAleatorios5Primeiros = numerosAleatorios.stream()
                .limit(5)
                .collect(Collectors.toSet());
        System.out.println(numerosAleatorios5Primeiros); Esse é um exemplo de lambda */
       ...
       // Object DatagramChannelImpl = new Object();
     //   AbstractSelectableChannels.forEach(System.out::println);
